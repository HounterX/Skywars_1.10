...
public class Config {
	...
	private void load() {
		if (SkyWarsReloaded.get().getConfig().getString("gameVariables.signJoinMaterial") != null) {
			...
			leaveCommand =  SkyWarsReloaded.get().getConfig().getBoolean("gameSettings.leaveCommand");
	...
	private void validateConfigValues() {
		...
		if (playerJoinLobby == null) {
			playerJoinLobby =  Sound.ENTITY_SLIME_JUMP;
